...
enum KeepAliveModeText {
    ...
    static var current: String {
        ...
        return UserDefaults.standard.bool(forKey: ViewController.userDefaultsIOS26AudioKeepAliveKey)
            ? L10n.text("音频强保活", "Audio Keep-alive")
            : L10n.text("PiP保活-低功耗", "PiP Keep-alive")
    }
    ...
    static var currentDescription: String {
        ...
        return UserDefaults.standard.bool(forKey: ViewController.userDefaultsIOS26AudioKeepAliveKey)
            ...
            : L10n.text("新方案仅PiP保活，经实测较老方案更为省电，保活效果一致，并且解决音频冲突问题，优先推荐", "Low-power PiP keep-alive is recommended. In testing it keeps similar background stability while using less power and avoiding audio conflicts.")
    }
